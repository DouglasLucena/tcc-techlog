      ...
      <main class="main-content">
        ...
        <section class="form-section">
          <div class="form-group">
            <label for="exampleFormControlSelect1">Selecione o veiculo:</label>
